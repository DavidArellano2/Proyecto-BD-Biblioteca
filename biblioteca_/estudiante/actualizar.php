            ...
            <section class="formulario-sec">
                ...
                while($row = mysqli_fetch_object($datos)){
                    ...
                    <div><?php echo $row->id;?></div>
                        ...
                        <div><a class="edit" 
                            href="/biblioteca/estudiante/querys/actualizarAlumno.php?id=<?php echo $row->id.'&Codigo='.$row->Codigo.'&Nombre='.$row->Nombre.'&Carrera='.$row->Carrera.'&Email='.$row->Email.'&Telefono='.$row->Telefono?>">
                        Editar</a></div>
                    </div>
                    <?php } ?>
                </div>
