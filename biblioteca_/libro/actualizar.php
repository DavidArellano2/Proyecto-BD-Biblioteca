            ...
            <section class="formulario-sec">
                ...
                while($row = mysqli_fetch_object($datos)){
                    ...
                    <div><?php echo $row->id;?></div>
                        ...
                        <div><a class="edit" 
                            href="/biblioteca/libro/querys/actualizarEmpleado.php?id=<?php echo $row->id.'&ISBN='.$row->ISBN.'&Titulo='.$row->Titulo.'&Autor='.$row->Autor.'&Editorial='.$row->Editorial.'&NumeroEjemplar='.$row->NumeroEjemplar.'&anoPublicacion='.$row->anoPublicacion.'&stock='.$row->stock;?>">
                        Editar</a></div>
                    </div>
                    <?php } ?>
                </div>
